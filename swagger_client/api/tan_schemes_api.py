...
class TANSchemesApi(object):
    ...
    def get_current_tan_media(self, access_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to retrieve the current TAN media. (required)
        :return: TanMedia
    ...
    def get_current_tan_scheme(self, access_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to retrieve the current TAN scheme. (required)
        :return: TanScheme
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_tan_schemes(self, access_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **id** for the access for which to retrieve the TAN list (required)
    ...
    def put_current_tan_media(self, access_id, tan_media_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to set the current TAN media. (required)
    ...
    def put_current_tan_scheme(self, access_id, tan_scheme_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to set the current TAN scheme. (required)
