...
class ForecastApi(object):
    ...
    def get_forecast(self, access_id, account_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to retrieve forecasts (required)
        :param int account_id: The **accountId** for which to retrieve forecasts (required)
        :return: Forecast
    ...
    def get_forecast_transactions(self, access_id, account_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for the forecast. (required)
        :param int account_id: The **id** for the account. (required)
