...
class TransactionPatternApi(object):
    ...
    def activate_transaction_pattern(self, access_id, account_id, pattern_id, activated, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to activate the pattern (required)
        :param int account_id: The **accountId** for which to activate the pattern (required)
        :param int pattern_id: The **patternId** to (de)activate (required)
        :param str activated: If `true`, the pattern will be used for forecast calculations;         `false` will be ignored (required)
    ...
    def delete_transaction_pattern(self, access_id, account_id, pattern_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for the transaction pattern to delete (required)
        :param int account_id: The **accountId** for the transaction pattern to delete (required)
        :param int pattern_id: The **patternId** to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_transaction_pattern(self, access_id, account_id, pattern_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for the pattern to retrieve (required)
        :param int account_id: The **accoundId** for the pattern to retrieve (required)
        :param int pattern_id: The **patternId** for the pattern to retrieve (required)
        :return: TransactionPattern
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_transaction_patterns(self, access_id, account_id, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** for which to retrieve transaction patterns (required)
        :param int account_id: The **accountId** for which to retrieve transaction patterns (required)
    ...
    def post_transaction_pattern(self, access_id, account_id, transaction_pattern_dto, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param int access_id: The **accessId** to which the new created pattern is associated with (required)
        :param int account_id: The **accountId** to which the new created pattern is associated with (required)
