...
class Provider(object):
    ...
    def id(self):
        ...
        Internal ID of this provider. A constant to identify provider even when,  for examplr, their bank code changes (provided type is BankProvider)  # noqa: E501
    ...
    def supported(self):
        ...
        Whether this bank is supported by the AHOI API (i.e., whether you can establish a connection to this provider).  # noqa: E501
